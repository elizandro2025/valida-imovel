      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200/80 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Badge variant="outline" className="hidden sm:flex border-slate-300 text-slate-600 bg-slate-50 gap-1 text-xs font-semibold">
              <ShieldCheck className="w-3 h-3 text-emerald-600" /> Painel Administrativo
            </Badge>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-lg text-xs font-semibold gap-1.5"
            >
